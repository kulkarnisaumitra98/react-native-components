...
const ListHeader = () => (
  <>
    ...
    <MyText>
      Like bordering list container, fixing its height,
      so for that we have to use flatlist inside scrollview
    </MyText>
...
const ListFooter = () => (
  <>
    ...
    <MyText>
      This method should be used when list is large and
      we want entire view to be scrollable and want to render the entire list as well
    </MyText>
